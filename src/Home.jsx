...
import JJHVideo from './assets/JJHVideo.mp4'
    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-t from-blue-950 to-cyan-800 text-white Background">
        {/* <video
          ...
          muted
          playsInline
          className="absolute top-0 z-70 left-0 opacity-7 w-full h-full object-cover"
        >
          <source src={JJHVideo} type="video/mp4" />
        </video> */}
         {/* <div className="absolute inset-0 bg-gradient-to-t from-blue-950 to-cyan-800 opacity-50"></div> */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                ...
                <button className="border border-white hover:bg-white hover:text-blue-800 px-8 py-4 rounded-lg font-semibold transition">
                  Explore Courses
                </button>
              </div>
            </div>
      ...
      {/* STATS */}
      <section className="py-16 z-50 bg-gray-50 bg-gay-50">
        <div className="max-w-7xl -mt-32 mx-auto px-6">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 mt-14">
            <div className="text-center">
              <Microscope className="mx-auto text-blue-900" size={50} />
              <h3 className="font-semibold mt-4">Modern Labs</h3>
            </div>

            <div className="text-center">
              <Users className="mx-auto text-blue-900" size={50} />
              <h3 className="font-semibold mt-4">Expert Faculty</h3>
            </div>

            <div className="text-center">
              <Award className="mx-auto text-blue-900" size={50} />
              <h3 className="font-semibold mt-4">Quality Education</h3>
            </div>

            <div className="text-center">
              <BookOpen className="mx-auto text-blue-900" size={50} />
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-r from-blue-900 to-cyan-900 rounded-3xl p-12 text-center text-white">
